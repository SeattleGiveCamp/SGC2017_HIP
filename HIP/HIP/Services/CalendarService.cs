...
namespace HIP.Services
{
	public static class CalendarService
	{
		...
		public static async Task<bool> AddReminderAsync(CalendarEvent calEvent)
		{
			...
			if (status != PermissionStatus.Granted)
			{
				...
				if (!request.ContainsKey(Permission.Calendar) || request[Permission.Calendar] != PermissionStatus.Granted)
				{
					if (alert)
					{
						...
						{
							MessagingService.Current.SendMessage<MessagingServiceQuestion>("question", new MessagingServiceQuestion
							{
